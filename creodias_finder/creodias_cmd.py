...
LOCAL_OUTPUT_DIR = '/tmp/Sentinel-2'
...
def download_scene(creodias_scene_uuid, out_file, credentials):
    ...
    while not downloaded:
        try:
            download.download(creodias_scene_uuid, outfile=out_file, **credentials)
...
def download_scenes_for_tile(tile_centroid_lon, tile_centroid_lat):
    ...
    CREDENTIALS = {'username': 'jiri.kadlec@gisat.cz', 'password': 'Earth6378'}
